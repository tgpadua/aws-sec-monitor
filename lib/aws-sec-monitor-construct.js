...
class AWSSecMonitorConstruct extends Construct {
  constructor(scope, id, props = {}) {
    ...
    const bucket = new s3.Bucket(this, 'S3Bucket', {bucketName: props.bucketName, blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL});
    ...
    const lambdaFunction = new lambda.Function(this, 'LambdaFunction', {
      ...
      environment: {
        ...
        ACCOUNTS_FILENAME: props.accountsFilename,
    ...
    // If you uncomment the following lines, your report will be publicly exposed by API Gateway
    //
    // const api = new apigateway.LambdaRestApi(this, RESOURCE_NAME, {
